    ...
    <footer className="bg-gray-100 text-gray-800 py-12">
      <div className="max-w-[1200px] mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
          {/* Company Name */}
          <div>
            <h3 className="text-[24px] font-extrabold text-[#0C3765]">AppExit</h3>
          </div>
          ...
          <div className="flex gap-3">
            <a href="#" className="w-10 h-10 rounded-full bg-gray-200 hover:bg-[#0C3765] hover:text-white transition-colors flex items-center justify-center">
